...
urlpatterns = [
    ...
    path('inventory/products/<uuid:product_id>/images/', v.AgentProductImagesView.as_view(),
         name='agent-inventory-product-images'),
    path('inventory/products/<uuid:product_id>/images/<int:pk>/', v.AgentProductImageDetailView.as_view(),
         name='agent-inventory-product-image-detail'),
