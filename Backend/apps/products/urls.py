...
urlpatterns = [
    ...
    path('admin/products/import/template/', views.AdminProductImportTemplateView.as_view(),
         name='admin-product-import-template'),
    path('admin/products/import/history/', views.AdminProductImportHistoryView.as_view(),
         name='admin-product-import-history'),
